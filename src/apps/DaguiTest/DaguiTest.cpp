...
#include "../../../ThirdParty/dag/thirdparty/dagbase/include/core/StateMachine.h"
...
public:
    MockShape()
    :
    dagui::Shape(dagbase::Atom::intern("MockShape"))
    {
        // Do nothing.
    }
...
INSTANTIATE_TEST_SUITE_P(EventSystem, EventSystem_testGenerateSecondaryEvents, ::testing::Values(
    ...
    std::make_tuple("data/tests/EventSystem/Chord.lua")
));
